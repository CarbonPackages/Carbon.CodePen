...
declare module '@neos-project/neos-ui' {
    ...
    import { SynchronousMetaRegistry, SynchronousRegistry } from '@mhsdesign/esbuild-neos-ui-extensibility/@neos-project/neos-ui-extensibility/src/registry'

    export interface GlobalRegistry extends SynchronousRegistry<SynchronousRegistry> {
    }

    export interface FrontendConfiguration extends Record<string | number, any> {
    }
...
declare module '@neos-project/neos-ui-editors' {
    export type EditorProps<Options = {}> = {
        ...
        value?: any;
        hooks?: object;
        renderSecondaryInspector(secondaryInspectorName: string, secondaryInspectorComponentFactory: () => React.ReactElement): void;
        editor: string;
...
declare module '@neos-project/neos-ui-decorators' {
    ...
    import {
        MapDispatchToPropsParam, MapStateToPropsParam, MergeProps, Options
    } from 'react-redux';
    ...
    export declare type NeosInjectedProps<R extends (...args: any[]) => any> = ReturnType<R> & {
...
declare module '@neos-project/neos-ui-extensibility' {
    ...
    import { GlobalRegistry, FrontendConfiguration } from '@neos-project/neos-ui';
